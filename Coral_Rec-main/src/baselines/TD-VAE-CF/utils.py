...
class Data(Dataset):
    def __init__(self, raw_data, num_items, max_len, mask_prob, mode='train'):
        ...
        self.raw_cats = raw_data[2]    # Crucial: Load Category Sequences
        self.raw_targets = raw_data[3]
        self.raw_ratings = raw_data[5] # Crucial: Load Rating Sequences
        ...
        # Additional attributes for Baseline/CORAL
    ...
    def _prepare_data(self):
        ...
        for i in range(len(self.raw_inputs)):
            ...
            # Filter out 0-padding from raw data to handle strictly
            seq_clean = []
            cat_clean = []
            rate_clean = []
            ...
            if self.mode == 'train':
                ...
                # Truncate to max_len + 1 (to have enough for input and target)
                ...
                # Test Mode: Input = Full Sequence, Target = Specific Item
